...
<div class="card">
    ...
    <a href="admin-panel.php" class="btn btn-light ">Înapoi</a>
             ...
             <div class="col-md-3"><h3>Detalii plăți</h3></div>
             <div class="col-md-8">
...
<input type="text" name="Payment_id" class="form-control"><br>
                   ...
                   <!-- <label>Customer Name</label>
                    ...
                    <label>Tipul plății</label>
                    
<input type="text" name="payment_type" class="form-control"><br> 
<input type="submit" class="btn btn-primary" name="pay_submit" value="Plătește">
     </div>
    </div>
    </div>
