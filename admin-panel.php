        ...
        <div class="col-md-3">
            <div class="list-group">
                <a href="" class="list-group-item active"
                   >Membri</a>
                <a href="trainer_details.php" class="list-group-item">Detalii membru</a>
                <a href="package.php" class="list-group-item">Detalii pachet antrenamente</a>
                <a href="payment.php" class="list-group-item">Plăți</a>
            </div>
            <hr>
            <div class="list-group">
              <a href="trainer.php" class="list-group-item active">Antrenor</a>
              <a href="trainer.php" class="list-group-item active">Detalii antrenor</a>             
              <a href="trainer.php" class="list-group-item active">Adaugă antrenor nou</a>
            </div>      
